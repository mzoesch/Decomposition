// SCC: (yaml_sequence_start_event_initialize)
...
int yaml_sequence_start_event_initialize(Unknown *event, const unsigned char *anchor, const unsigned char *tag, int implicit, Unknown style);


// Function: yaml_sequence_start_event_initialize
// Path: /mnt/sdb1/ba/LlvmPlugin/Plugin/Examples/005_libyaml/src/api.c
#include ".0107Scc_yaml_sequence_start_event_initialize_yaml_sequence_start_event_initialize.fwd"
