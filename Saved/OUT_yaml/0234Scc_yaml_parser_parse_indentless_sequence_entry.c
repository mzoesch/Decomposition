// SCC: (yaml_parser_parse_indentless_sequence_entry)
...
#include ".0234Scc_yaml_parser_parse_indentless_sequence_entry_yaml_parser_parse_indentless_sequence_entry.fwd"
